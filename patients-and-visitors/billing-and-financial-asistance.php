...
<html lang="en">
  ...
  <body>
    ...
    <div class="header-hero-container">
      ...
      <section id="sectionHeader">
        <div class="section-image-container">
          <div class="header-bg-image billing-and-financial-bg-image"></div>
        </div>
        <div class="container">
          <!--max-width: 80px-->
          <div class="you-are-here flex breadcrumb">
            ...
            <ul style="padding: 0.5em 0">
              ...
              <li style="color: #bbbbbb">Accepted-Insurance</li>
            </ul>
          </div>
        </div>
      </section>
    ...
    <!---------------------------------------------------------------------MAIN PAGE CONTENT----------------------------------------------------------------->
    <main>
      <section id="Billing-and-financial-assitance">
        <div class="container">
          <div class="flex align-start">
            <!--column to left-->
            <div class="col-70">
              <div class="billing-wrapper">
                <h3 class="purple-text">Billing Information</h3>
                <p>
                  Tampa General Hospital patients will receive care from Tampa
                  General Hospital and many of its affiliated providers. Because
                  of this, patients will receive bills from a number of
                  different providers for the various services provided. These
                  providers may or may not participate in the same health plans
                  as Tampa General Hospital. We encourage you to contact their
                  provider to determine health plan participation. For example,
                  a patient that visits the TGH Emergency Department will
                  receive separate bills from different providers for:
                </p>

                <ul class="margin-bottom circular-dots">
                  <li>Emergency department physician services.</li>
                  <li>Any lab work completed and reviewed by a pathologist.</li>
                  <li>Radiologist (X-ray / CT / MRI / Ultrasound) services.</li>
                  <li>EKG or other study interpretation.</li>
                </ul>

                <p>
                  Another patient who is admitted for a scheduled surgery will
                  receive separate bills from different providers for:
                </p>

                <ul class="circular-dots">
                  <li>Anesthesiology services.</li>
                  <li>Any lab work completed and reviewed by a pathologist.</li>
                  <li>Physician consultation services.</li>
                  <li>EKG or other study interpretation.</li>
                </ul>
              </div>
            </div>
